...
from spice_tools.mosaics.misc import get_nadir_point_surface_velocity_kps, \
...
class TestMisc(TestCase):
    ...
    @patch('spice_tools.mosaics.misc.spy.subpnt',
           side_effect=20*[ ((0.0, 0.0, 12345.0), 45.5, (0.0, 0.0, 3630.0)),
                         ((300.0, 400.0, 12345.0), 45.7, (0.0, 0.0, 3430.0))])
    @patch('spice_tools.mosaics.misc.datetime2et', side_effect=20*[1346879.3, 1346889.3])
    ...
    @patch('spice_tools.mosaics.misc.datetime2et', return_value = 1346879.3)
    ...
    @patch('spice_tools.mosaics.misc.get_nadir_point_surface_velocity_kps', side_effect=20*[5.0, 3.3])
    @patch('spice_tools.mosaics.misc.get_pixel_size_km',                    side_effect=20*[0.5, 1.0])
    ...
    def test_get_body_angular_diameter_rad(self):
        with patch('spice_tools.mosaics.misc.spy.limbpt', return_value=[(1, 1), None, None, [(1.0, 0.0, 0.0), (0.894808, 0.173648, 0.0)]]) as mock_limbpt:
            with patch('spice_tools.mosaics.misc.datetime2et', return_value=134596.3) as mock_datetime2et:
    ...
    def test_datetime2et(self):
        ...
        with patch('spice_tools.mosaics.misc.spy.str2et') as mock:
