...
class TestMosaicGenerator(TestCase):
    ...
    @patch('mapps_tools.mosaics.DiskMosaic.spy.str2et', return_value=1.0)
    @patch('mapps_tools.mosaics.MosaicGenerator.get_body_angular_diameter_rad', return_value=0.19167923151263316)
    ...
    @patch('mapps_tools.mosaics.MosaicGenerator.DiskMosaic')
